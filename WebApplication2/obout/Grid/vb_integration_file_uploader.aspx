...
<script language="VB" runat="server">
   Sub Page_load(ByVal sender As Object, ByVal e As EventArgs)              
        ...
        Else
            ...
            Dim imagesPath As String = "resources/images/products/"
        ...
        Next i
            ...
            If ProductID <> Nothing Then
                If ProductID.Length > 0 And Not String.IsNullOrEmpty(photoName) Then            
                    Dim myConn As OleDbConnection = New OleDbConnection("Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + Server.MapPath("../App_Data/Northwind.mdb"))
                    myConn.Open()

                    Dim myComm As OleDbCommand = New OleDbCommand("UPDATE Products SET [Image] = @Image WHERE ProductID = @ProductID", myConn)
    ...
    Sub CreateGrid()   
        ...
        Dim myComm As OleDbCommand = New OleDbCommand("SELECT TOP 7 * FROM Products ORDER BY ProductID ASC", myConn)
        myConn.Open()
