...
    
    ...
    Private Sub ListOrders(ByVal customerId As String)
        Dim myConn As New OleDbConnection("Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + Server.MapPath("../App_Data/Northwind.mdb"))
    
        Dim myComm As New OleDbCommand("SELECT TOP 25 * FROM Orders WHERE CustomerId=@CustomerId", myConn)
        '
...
    
    ...
    Protected Sub grid2_Rebind(ByVal sender As Object, ByVal e As EventArgs)
        If Session("customerId") IsNot Nothing Then
            ListOrders(Session("customerId").ToString())
        End If
    End Sub
